<template>
  <Loader v-if="loading" />
  <el-carousel v-if="!loading" class="event__slider" :interval="5000" arrow="never" indicator-position="outside"
    autoplay="true">
    <el-carousel-item class="home-slider-item--wrap cursor-pointer" v-for="(popular, i) in paginatedPopular" :key="i">
      <v-row>
        <v-col v-for="(event, index) in popular" :key="index" cols="12" sm="4" md="4" xl="4" lg="4">
