<template>
  <v-card class="event-card rounded-xl cursor-pointer" @click="viewEvent(eventData)">
    ...
    <v-overlay :model-value="checkEventEnded()" class="align-center justify-center" scrim="grey" contained>
    </v-overlay>

    <div>
      <v-img class="align-end text-white" height="200" :src="eventData.banner" cover>
      </v-img>
      ...
      <div class="card__footer">
        ...
        <v-card-actions class="d-flex align-center justify-space-between">
          <div class="d-flex align-center">
            ...
            <img v-if="eventData.communityDetail?.hasDomainVerified" src="@/assets/images/verify.svg" height="16" />
          </div>
          <div class="d-flex align-center">
