      ...
      <div class="homepage-section">
        <div class="section-content">
          <div class="user__profile">
            <v-card color="transparent" class="bg__card">
              <v-card-text class="profile__container">
                ...
                <div class="profile__social__meta">
                  ...
                  <a href="">
                    ...
                    >
                      <path
                        d="M1 2H3.27273L16.9091 20.1818H14.6364L1 2Z"
                        fill="white"
                        fill-opacity="0.2"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M2.81836 2H7.36381V3.81818H2.81836V2Z"
                        fill="white"
                        fill-opacity="0.2"
                      />
                      <path
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    <div class="level__sec">
                      ...
                      <p>Need 140 points to reach the next level</p>
                    </div>
                  </v-col>
                </v-row>
              </v-card-text>
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    v-if="item.slug === 'events' && eventData.length > 0"
                  ...
                  <v-row class="mt-5" v-if="!loading && eventData.length === 0">
                    <v-col cols="12">
                      <div class="d-flex align-center justify-center height-200">
                        <p
                          class="font-25 lh-26 mx-5 purple-linear-gradient-text font-weight-medium"
                        >
                          No events found!
                        </p>
                      </div>
